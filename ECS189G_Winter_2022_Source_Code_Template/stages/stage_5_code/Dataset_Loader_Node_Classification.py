...
class Dataset_Loader(dataset):
    ...
    def load(self):
        ...
        # the following part, you can either put them into the setting class or you can leave them in the dataset
        # loader the following train, test, val index are just examples, sample the train, test according to project
        # requirements
        # You may need to change the idx_train, idx_test, idx_val according to the project descriptions by yourself
